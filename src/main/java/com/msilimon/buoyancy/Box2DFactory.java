...
public class Box2DFactory {
    ...
    public static FixtureDef createFixture(Shape shape, float density, float friction,
                                           float restitution, boolean isSensor, short groupIndex) {
    ...
    public static Body createWalls(World world, float viewportWidth,
                                   float viewportHeight, float offset, short groupIndex) {
        ...
        FixtureDef fixtureDef = createFixture(shape, 1, 0.5f, 0, false, groupIndex);
